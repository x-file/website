...
public class Video extends DataEntity<Video> {
    ...
    public static final String DEFAULT_TEMPLATE = "frontViewVideo";
    ...
    private String customContentView;	// 自定义视频视图
   	private String viewConfig;	// 视图参数

	private VideoData videoData;	//文章副表
	...
	public void setPosidList(List<String> list) {
   	...
   	public String getUrl() {
        return CmsUtils.getVideoUrlDynamic(this);
   	}
